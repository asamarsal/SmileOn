...
/// Halaman Kategori Detail: Semua Riwayat Transaksi
class LastTransactionActivityScreen extends ConsumerWidget {
  const LastTransactionActivityScreen({super.key});
