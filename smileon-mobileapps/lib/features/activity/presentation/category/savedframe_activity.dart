...
/// Halaman Kategori Detail: Semua Frame Disimpan
class SavedFrameActivityScreen extends ConsumerWidget {
  const SavedFrameActivityScreen({super.key});
