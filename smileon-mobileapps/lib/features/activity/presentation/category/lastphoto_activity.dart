...
/// Halaman Kategori Detail: Semua Foto Terakhir
class LastPhotoActivityScreen extends ConsumerWidget {
  const LastPhotoActivityScreen({super.key});
