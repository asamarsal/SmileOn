...
/// Screen "Siapkan Sesi Foto" (Mode Personal)
/// Tampilan modern sesuai desain figma/mockup dengan foto memories di atas,
/// form nama sesi, lokasi, orang di foto, pemilihan frame, toggle Google Drive,
/// dan aksi Simpan ke Draft serta Simpan & Mulai.
class NewSessionPersonalScreen extends ConsumerStatefulWidget {
  final String? initialFrameTitle;
  final String? initialFrameAsset;

  const NewSessionPersonalScreen({
    super.key,
  ...
  @override
  ConsumerState<NewSessionPersonalScreen> createState() =>
      _NewSessionPersonalScreenState();
}

class _NewSessionPersonalScreenState
    extends ConsumerState<NewSessionPersonalScreen> {
  ...
  void _handleSaveAndStart() {
    ...
    SmileToast.showSuccess(
      context,
      title: 'Sesi Siap',
      message: 'Memulai sesi personal...',
      duration: const Duration(seconds: 1),
    );

    // Buka ActiveCameraScreen
    Navigator.push(
      context,
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Contoh: Mall Gandaria City',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. Top Image Banner dengan foto sahabat ceria & ornamen Good Memories
          Positioned(
            top: 0,
            left: 0,
            right: 0,
          ...
          // 4. Header Bar: Tombol Back & Badge Personal
          Positioned(
            top: 0,
            left: 0,
            right: 0,
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // Badge Mode Personal di kanan atas
                    Container(
                      padding: const EdgeInsets.symmetric(
                        horizontal: 12,
                        vertical: 6,
