...
/// Halaman Detail Kategori: Paket Event
class EventCategoryEventVoucherScreen extends ConsumerStatefulWidget {
  const EventCategoryEventVoucherScreen({super.key});

  @override
  ConsumerState<EventCategoryEventVoucherScreen> createState() =>
      _EventCategoryEventVoucherScreenState();
}

class _EventCategoryEventVoucherScreenState
    extends ConsumerState<EventCategoryEventVoucherScreen> {
  String _selectedPayment = 'monad';

  final List<Map<String, dynamic>> _eventList = const [
    {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // 2. Daftar Paket Event
              Column(
                children: _eventList.map((item) {
                  return _buildEventItemCard(context, item, t);
                }).toList(),
              ),
