...
/// Halaman Detail Kategori: Membership
class MemberCategoryEventVoucherScreen extends ConsumerStatefulWidget {
  const MemberCategoryEventVoucherScreen({super.key});

  @override
  ConsumerState<MemberCategoryEventVoucherScreen> createState() =>
      _MemberCategoryEventVoucherScreenState();
}

class _MemberCategoryEventVoucherScreenState
    extends ConsumerState<MemberCategoryEventVoucherScreen> {
  String _selectedPayment = 'monad';

  final List<Map<String, dynamic>> _memberList = const [
    {
      'title': 'VIP Member 1 Bulan',
      'photos': '50 Foto/bln + Frame Eksklusif',
      'price': 'Rp 75.000',
      'crypto': '0.75 MON',
      'discount': 'Hemat 40%',
      'image': 'assets/images/voucher/graduation_package.jpg',
    },
    {
      'title': 'VIP Member 3 Bulan',
      'photos': '200 Foto + Bebas All Frame',
      'price': 'Rp 180.000',
      'crypto': '1.80 MON',
      'discount': 'Hemat 50%',
    ...
    {
      'title': 'VIP Lifetime Member',
      'photos': 'Unlimited Download + All Frame',
      'price': 'Rp 450.000',
      'crypto': '4.50 MON',
      'discount': 'Hemat 65%',
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // 2. Daftar Paket Member
              Column(
                children: _memberList.map((item) {
                  return _buildMemberItemCard(context, item, t);
                }).toList(),
              ),
